...
export default class For<T extends IBase<T>> extends Directive<T> {
    ...
    constructor(owner: IBase<T>, scope: IScope<T>, node: Node, binding: IBinding<T>, { fragment, name, key }: ForConf<T>);
    get fragment(): IFragment<T>;
    set fragment(fragment: IFragment<T>);
    private _initialize;
    render(): Promise<void>;
    static scan(node: Attr, map: Map<string, any>): Promise<FragmentLike>;
